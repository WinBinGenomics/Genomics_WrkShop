...
setwd("/data/shared/snigenda/finwhale_projects/filteredvcf/workshop/LD_analysis/GONE2")
...
# GOC PLOT
goc <- read.table("GOC/GOC_GONE2_Ne", header = TRUE)
...
# ENP PLOT
enp <- read.table("ENP/ENP_GONE2_Ne", header = TRUE)
